                                                                    ...
                                                                    <div class="page-title-actions mr-5" style="font-size: 20px;">
                                                                        ...
                                                                        if (empty($time)) {
                                                                            ...
                                                                            <button id="liveButton"
                                                                                style="display: block; position: fixed; top: 20px; right: 20px; background-color: red; color: white; padding: 10px 20px; font-size: 16px; border: none; border-radius: 5px; z-index: 9999;">
                                                                                Live
                                                                            </button>
                                                                        <?php }
                                                                        ?>
